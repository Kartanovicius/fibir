...
export default function Header({
  ...
  return (
    <div className="grid grid-cols-3 gap-4 justify-between mx-auto max-w-screen-lg bg-black-light p-5 text-white">
      ...
      <div className="flex items-center justify-center flex-col col-span-2">
        <div className="container flex items-baseline">
          <p className="text-4xl mr-4">{profileUsername}</p>
          <p className="text-sm">{!fullName ? <Skeleton count={1} height={24} /> : fullName}</p>
